...
class CNN_LSTM(BaseModel):
    ...
    def __init__(self, config):
        ...
        self.gru_1 = self.config.model.layers.GRU_layer_1
        self.gru_2 = self.config.model.layers.GRU_layer_2
        self.gru_3 = self.config.model.layers.GRU_layer_3
...
#        with strategy.scope():
        ...
        self.model.add(tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(self.gru_1, activation = 'tanh',kernel_initializer='glorot_normal', return_sequences=True)))
            
        self.model.add(tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(self.gru_2, activation = 'tanh',kernel_initializer='glorot_normal', return_sequences=True)))
            
        self.model.add(tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(self.gru_3, activation = 'tanh', kernel_initializer='glorot_normal', return_sequences=True)))
    ...
    def train(self, checkpoint):
        ...
        dataset_name = "/root/lzd2/RealEvents/exp6-100gru3-2000epoch_SNR10-20-NoNoise/Saved_checkpoint"
        ...
        self.model.save("/root/lzd2/RealEvents/exp6-100gru3-2000epoch_SNR10-20-NoNoise/trained_model.h5")
#        print("Saved model to disk")
    ...
    def plot_loss_curves(self, loss, val_loss):
        ...
        plt.savefig("/root/lzd2/RealEvents/exp6-100gru3-2000epoch_SNR10-20-NoNoise/Accuracy_curve.png", dpi=200)
...
#        predictions = []
        ...
        f1 = h5py.File('/root/lzd2/RealEvents/exp6-100gru3-2000epoch_SNR10-20-NoNoise/results_snr_20.hdf', 'w')
